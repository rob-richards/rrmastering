...
import logoImage from '@/images/rr-logo.svg'
  ...
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
        ...
        <NavItem href="/software/producers-cheat-sheet">Cheat Sheet</NavItem>
...
function Logo({ large = false, className, ...props }) {
  return (
    <Link
      href="/"
      aria-label="Rob Richards Mastering"
      className={clsx(className, 'pointer-events-auto bg-white')}
      {...props}
    >
      <Image
        src={logoImage}
